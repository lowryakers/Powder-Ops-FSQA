...
const PUBLIC_ROUTES = [
  ...
  { prefix: '/nfp-link/' },
  // FORM 404-1 completed by a supplier on a signed link. The supplier has no
  // account by definition; the token is compared as a SHA-256 hash in the
  // handler and scoped to that one questionnaire — read it, save answers,
  // attach documents, sign once. Nothing else in the register is reachable.
  { prefix: '/supplier-questionnaire/' },
