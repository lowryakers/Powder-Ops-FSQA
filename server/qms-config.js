...
export const QMS_TYPES = {
  ...
  knife_masterlist: {
    key: 'knife_masterlist',
    label: 'Knife / Blade Master List',
    singular: 'Knife / Blade Master List Entry',
    short: 'KBM',
    moduleId: 'knife-masterlist',
    formCode: 'Form 440-01',
    numberPrefix: 'KBM-',
    numberPad: 3,
    primaryField: 'tool_id',
    dateLabel: 'Date Marked',
    statuses: [
    ...
    fields: [
      ...
      { key: 'decommission_date', label: 'Decommission Date', type: 'date' },
    ],
    logColumns: ['record_number', 'tool_id', 'marked_by', 'record_date', 'status'],
    approvals: [],
  },
  ...
  knife_accountability: {
    ...
    singular: 'Knife / Blade Accountability',
    short: 'KBA',
    ...
    fields: [
      { key: 'tool_id', label: 'Knife / Razor Blade / Scissor #', type: 'text' },
      { key: 'issued_to', label: 'Person Issued To', type: 'text' },
      { key: 'issued_by', label: 'Issued By (QA)', type: 'text' },
      { key: 'issue_condition', label: 'Condition at Issue', type: 'select', options: ['Good', 'Bad'] },
      { key: 'returned_by', label: 'Person Returning', type: 'text' },
      { key: 'retrieved_by', label: 'Retrieved By (QA)', type: 'text' },
      { key: 'return_condition', label: 'Condition at Return', type: 'select', options: ['Good', 'Bad'] },
    ],
    logColumns: ['record_number', 'tool_id', 'issued_to', 'record_date', 'status'],
    approvals: [],
  },
