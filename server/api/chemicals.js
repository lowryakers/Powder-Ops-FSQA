...
router.post('/', (req, res) => {
  const db = getDb();
  const { name, category, manufacturer, product_code, sds_number, sds_url, is_food_grade, nsf_rating, approved_applications, max_concentration, required_contact_time_minutes, review_due, notes, location_for_use } = req.body;
...
router.put('/:id', (req, res) => {
  ...
  const { name, category, manufacturer, product_code, sds_number, sds_url, is_food_grade, nsf_rating, approved_applications, max_concentration, required_contact_time_minutes, is_active, review_due, notes, location_for_use } = req.body;
  db.prepare(`
