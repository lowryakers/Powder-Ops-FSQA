...
router.post('/templates', (req, res) => {
  ...
  logAudit(req.user, 'create', 'checklist_template', id, { name, type }, null, created);
...
router.put('/templates/:id', (req, res) => {
  ...
  logAudit(req.user, 'update', 'checklist_template', req.params.id, null, existing, updated);
  res.json(updated);
});
...
router.post('/instances/:id/skip', (req, res) => {
  ...
  logAudit(req.user, 'skip', 'checklist_instance', req.params.id, null, null, null);
