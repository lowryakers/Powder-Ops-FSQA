...
const MODULE_GROUPS = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'ap-drop', label: 'AP Drop (finance intake queue)', note: 'The first tab of Accounting. Everyone set up in Settings can drop a finance PDF and see their own drops without this. Edit is the finance flag: it opens the whole queue and lets the person move a drop past "new", correct what was read off the document, and mark one as not finance.' },
